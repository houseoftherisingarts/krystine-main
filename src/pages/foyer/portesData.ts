...
export const PORTES: Porte[] = [
  { n: 'octobre', mois: 'Octobre', b: [93, 124, 325, 381], src: 'porte-octobre-cutout', mouvement: 'La nature se dépouille', theme: 'Élaguer pour mieux voir', question: 'Certaines choses prennent de la place longtemps après avoir cessé de nous nourrir.' },
