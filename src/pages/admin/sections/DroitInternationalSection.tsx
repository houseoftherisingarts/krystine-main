...
const DOSSIERS: Dossier[] = [
  ...
  },
  {
    ...
    statut: 'Vous êtes visée',
    corps: [
      "La réforme québécoise est entrée en vigueur par vagues. La première, le 22 septembre 2022, a rendu obligatoire le registre des incidents de confidentialité et a interdit d'activer par défaut les témoins de navigation qui servent au profilage. Un an plus tard jour pour jour, il a fallu désigner une personne responsable de la protection des renseignements personnels et publier ses coordonnées, adopter une politique de confidentialité écrite en langage simple, et recueillir un consentement manifeste et libre pour des fins précises. La dernière vague, le 22 septembre 2024, a ajouté le droit à la portabilité, qui permet à une cliente de repartir avec ses données dans un format lisible par une autre plateforme.",
  ...
  },
  {
    ...
    corps: [
      ...
      "L'article 17 de la loi québécoise sur le secteur privé demande qu'avant de laisser un renseignement personnel sortir du Québec, l'entreprise évalue par écrit quatre choses : la sensibilité du renseignement, l'usage qui en sera fait, la protection dont il jouira là-bas, et les lois du pays d'arrivée. L'évaluation ne se dépose nulle part, elle se garde dans vos dossiers, et elle se sort le jour où la Commission d'accès à l'information pose la question.",
