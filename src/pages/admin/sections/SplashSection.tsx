    ...
    <div className="space-y-6 max-w-3xl">
      <Card className="p-6">
        <div className="flex items-center justify-between mb-2">
          <h3 className="text-sm uppercase tracking-widest text-[#2a2015]/60 dark:text-white/60 font-bold">Affichage</h3>
        ...
        <p className="text-xs text-[#2a2015]/50 dark:text-white/50">
          ...
          <br />
          <a href="/?splash=1" target="_blank" rel="noopener noreferrer" className="text-[#7d6330] underline">Aperçu en direct ↗</a>
        </p>
      </Card>

      <Card className="p-6 space-y-5">
        <h3 className="text-sm uppercase tracking-widest text-[#2a2015]/60 dark:text-white/60 font-bold">Contenu (FR)</h3>
        <div>
      ...
      <Card className="p-6 space-y-5">
        <h3 className="text-sm uppercase tracking-widest text-[#2a2015]/60 dark:text-white/60 font-bold">Contenu (EN — facultatif)</h3>
        <p className="text-xs text-[#2a2015]/50 dark:text-white/50 -mt-2">Si vide, le texte FR est utilisé.</p>
        <div>
          <Label>Tagline</Label>
