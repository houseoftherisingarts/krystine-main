    ...
    <div className="space-y-5">
      ...
      <Card className="p-5">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2">
          ...
          {seedMsg && <span className="text-[11px] text-[#293027]/60 dark:text-white/60 italic">· {seedMsg}</span>}
        </div>
      </Card>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="relative flex-1 min-w-[200px] max-w-sm ml-auto">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-full border border-[#293027]/10 dark:border-white/10 bg-white dark:bg-white/5 text-sm text-[#293027] dark:text-white placeholder:text-[#293027]/40 dark:placeholder:text-white/40 focus:outline-none focus:border-[#BA7B39]"
          />
        </div>
      </div>
