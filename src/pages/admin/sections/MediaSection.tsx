    ...
    <div className="space-y-5">
      ...
      <Card className="p-5">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2">
          ...
          {seedMsg && <span className="text-[11px] text-[#2a2015]/60 dark:text-white/60 italic">· {seedMsg}</span>}
        </div>
      </Card>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="relative flex-1 min-w-[200px] max-w-sm ml-auto">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-full border border-[#2a2015]/10 dark:border-white/10 bg-white dark:bg-white/5 text-sm text-[#2a2015] dark:text-white placeholder:text-[#2a2015]/40 dark:placeholder:text-white/40 focus:outline-none focus:border-[#bb9a5e]"
          />
        </div>
      </div>
          ...
          {filtered.map(m => (
            <Card key={m.id} className="overflow-hidden">
              <div className="relative">
                <div className="aspect-square bg-cover bg-center bg-[#f6f3ee] dark:bg-white/5" style={{ backgroundImage: `url(${m.url})` }} />
                {m.source === 'linked' && (
              ...
              <div className="p-3 space-y-2">
                <p className="text-xs text-[#2a2015]/80 dark:text-white/80 truncate font-medium" title={m.name}>{m.name}</p>
                {m.category && (
                  <p className="text-[10px] uppercase tracking-widest text-[#2a2015]/40 dark:text-white/40">{m.category}</p>
                )}
