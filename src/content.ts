...
export const ASSETS = {
  ...
  formationsBg: `https://storage.googleapis.com/origine1/krystine%20red%20NG.webp`,
...
export const CONTENT = {
  FR: {
    ...
    cards: {
      founder: { title: 'Krystine St-Laurent', subtitle: 'Découvrir', link: '/krystine' },
      shop: { title: 'Boutique Inspirata Ayurveda', subtitle: 'Magasiner', link: '/boutique', locations: 'Points de Ventes' },
      ayurveda: { title: 'Ayurveda & Quiz Dosha', subtitle: 'Explorer', link: '/ayurveda' },
      livres: { title: 'Livres', subtitle: 'Lire', link: '/livres' },
      formations: { title: 'Formations', subtitle: 'Parcourir', link: '/formations' },
      blog: { title: 'Podcast & Médias', subtitle: 'Explorez nos contenus', link: '/medias' },
      evenements: { title: 'Événements', subtitle: 'Rejoindre', link: '/evenements' },
    },
    gem: {
  ...
  EN: {
    ...
    cards: {
      founder: { title: 'Krystine St-Laurent', subtitle: 'Discover', link: '/krystine' },
      shop: { title: 'Inspirata Ayurveda Shop', subtitle: 'Shop Now', link: '/boutique', locations: 'Sales Points' },
      ayurveda: { title: 'Ayurveda & Quiz Dosha', subtitle: 'Explore', link: '/ayurveda' },
      livres: { title: 'Books', subtitle: 'Read', link: '/livres' },
      formations: { title: 'Programs', subtitle: 'Browse', link: '/formations' },
      blog: { title: 'Podcast & Media', subtitle: 'Explore our content', link: '/medias' },
      evenements: { title: 'Events', subtitle: 'Join us', link: '/evenements' },
    },
