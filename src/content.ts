...
export const ASSETS = {
  ...
  // Horizontal Quebec-mountain backdrop layered behind the footer's navy tint.
  // Served from /public so we keep a local, predictable asset.
  footerBg: `/footer-jacques-cartier.jpg`,
...
export const CONTENT = {
  FR: {
    ...
    cards: {
      ...
      shop: {
        ...
        subtitle: 'Magasiner',
        link: '/boutique',
        locations: 'Points de Ventes',
        banner: "S'envelopper",
        bannerSub: 'de nature',
        cta: 'Magasiner',
      },
      ayurveda: { title: 'Ayurveda & Quiz Dosha', subtitle: 'Explorer', link: '/medias#ayurveda', banner: '', cta: 'Explorer' },
      livres: { title: 'Livres', subtitle: 'Lire', link: '/medias#livres', banner: '', cta: 'Lire' },
      formations: {
        title: 'Formations',
        subtitle: 'Parcourir',
        link: '/formations',
      ...
      blog: {
        title: 'Le Podcast : Au-delà des tendances',
        subtitle: 'Le podcast qui écoute ce que le corps sait déjà.',
        link: '/podcast',
        banner: 'Écouter',
        cta: 'Épisodes',
      },
      evenements: { title: 'Événements', subtitle: 'Rejoindre', link: '/formations#evenements', banner: '', cta: 'Rejoindre' },
    },
    gem: {
    ...
    media: {
      ...
      details: {
        ...
        tv: {
          ...
          desc: 'Trois saisons de Santé la vie, et toutes les capsules qui les ont précédées.',
          videos: [
        ...
        book: {
          ...
          items: [
            ...
            {
              title: 'Énergie & Ayurveda',
              subtitle: 'Sagesses, cuisine intuitive et rituels essentiels',
              releaseDate: '14 octobre 2026',
  ...
  EN: {
    ...
    cards: {
      ...
      shop: {
        title: 'Inspirata Ayurveda Shop',
        subtitle: 'Shop Now',
        link: '/boutique',
        locations: 'Sales Points',
        banner: 'Wrap yourself',
        bannerSub: 'in nature',
        cta: 'Shop Now',
      },
      ayurveda: { title: 'Ayurveda & Quiz Dosha', subtitle: 'Explore', link: '/medias#ayurveda', banner: '', cta: 'Explore' },
      livres: { title: 'Books', subtitle: 'Read', link: '/medias#livres', banner: '', cta: 'Read' },
      formations: {
        title: 'Programs',
        subtitle: 'Browse',
        link: '/formations',
      ...
      blog: {
        title: 'The Podcast: Beyond Trends',
        subtitle: 'The podcast that listens to what the body already knows.',
        link: '/podcast',
        banner: 'Listen',
        cta: 'Episodes',
      },
      evenements: { title: 'Events', subtitle: 'Join us', link: '/formations#evenements', banner: '', cta: 'Join' },
    },
    ...
    media: {
      ...
      details: {
        ...
        tv: { title: 'TV Shows & Interviews', desc: 'Three seasons of Santé la vie, plus every capsule that came before.', videos: [{ id: 'v9uMfDmQ2YE', title: 'Santé! La Vie!' }, { id: 'fxzVTt5RfBw', title: 'Salut Bonjour' }, { id: '8t1BfEk_2do', title: 'François Lemay' }, { id: 'wtQ_MEgkrVE', title: 'Daniel Blouin' }, { id: 'ab-EEYQi7yM', title: 'France Gauthier' }, { id: 't3KNbXTyI5I', title: 'Diva Yoga - Interview' }, { id: '2KWQuUbhmsU', title: 'Diva Yoga - Ritual' }] },
        book: { title: 'Our Books', items: [
          ...
          {
            title: 'Energy & Ayurveda',
            subtitle: 'Wisdoms, intuitive cooking and essential rituals',
