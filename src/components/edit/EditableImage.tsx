      ...
      >
        ...
        {editMode && (
          <>
            ...
            <div className="pointer-events-none absolute inset-0 ring-2 ring-[#bb9a5e]/80 ring-inset rounded-[inherit]" />

            {/* Focal point crosshair */}
            <div
              className="pointer-events-none absolute w-8 h-8 rounded-full border-2 border-white shadow-[0_0_0_2px_rgba(187, 154, 94,0.9)] -translate-x-1/2 -translate-y-1/2"
            ...
            <button
              ...
              className="absolute top-3 left-3 inline-flex items-center gap-2 bg-[#2a2015] text-[#7d6330] border border-[#bb9a5e] px-3 py-1.5 rounded-full text-[10px] uppercase tracking-widest font-bold shadow-lg hover:bg-[#bb9a5e] hover:text-[#2a2015] transition-colors"
            >
            ...
            {/* Hint */}
            <div className="absolute bottom-3 left-3 right-3 text-[10px] uppercase tracking-widest font-bold text-white/90 bg-[#2a2015]/70 backdrop-blur px-3 py-1.5 rounded-full text-center pointer-events-none">
