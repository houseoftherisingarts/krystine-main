...
const WaitlistModal: React.FC<WaitlistModalProps> = ({ target, onClose }) => {
  ...
  return (
    <Portail>
    <div className="fixed inset-0 z-[120] flex items-center justify-center overflow-y-auto overscroll-contain p-4 bg-[#2a2015]/60 backdrop-blur-md" onClick={close}>
      <div
        className="relative w-full max-w-md bg-white dark:bg-[#2a2015] rounded-[30px] shadow-2xl border border-[#bb9a5e]/20 p-8 md:p-10"
      ...
      >
        ...
        <h2 className="font-serif text-3xl text-[#2a2015] dark:text-white mb-2">
          {lang === 'FR' ? "Liste d'attente" : 'Join the waitlist'}
        </h2>
        <p className="text-sm text-[#2a2015]/60 dark:text-white/60 mb-6 font-serif italic">
          {lang === 'FR'
        ...
        {done ? (
          <div className="text-center py-6">
            ...
            <p className="font-serif italic text-[#2a2015] dark:text-white">
              {lang === 'FR'
            ...
            <button
              onClick={close}
              className="mt-6 inline-flex items-center gap-2 bg-[#2a2015] dark:bg-[#bb9a5e] text-white dark:text-[#2a2015] px-8 py-3 rounded-full font-bold uppercase tracking-widest text-xs hover:bg-[#bb9a5e] hover:text-[#2a2015] transition-colors"
            >
          ...
          <form onSubmit={submit} className="space-y-3">
            <input
              ...
              className="w-full px-5 py-3 rounded-full border border-[#2a2015]/15 dark:border-white/15 bg-white dark:bg-white/5 text-sm text-[#2a2015] dark:text-white placeholder:text-[#2a2015]/40 dark:placeholder:text-white/40 focus:outline-none focus:border-[#bb9a5e]"
            />
            <input
              type="email"
              required
            ...
            <button
              type="submit"
              disabled={busy}
              className="w-full bg-[#2a2015] dark:bg-[#bb9a5e] text-white dark:text-[#2a2015] px-6 py-3 rounded-full font-bold uppercase tracking-widest text-xs hover:bg-[#bb9a5e] hover:text-[#2a2015] transition-colors disabled:opacity-60"
            >
              {busy
