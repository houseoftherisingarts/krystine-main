...
const ShareButtons: React.FC<Props> = ({ title, url, className = '', compact = false }) => {
  ...
  return (
    <div className={`inline-flex items-center gap-2 ${className}`}>
      <span className="text-[10px] uppercase tracking-[0.3em] font-bold text-[#2a2015]/60 dark:text-white/60 mr-1">
      ...
      <button
        ...
        aria-label="Facebook"
        title="Facebook"
        className={`${iconBtn} border-[#2a2015]/15 dark:border-white/15 text-[#2a2015]/70 dark:text-white/70 hover:border-[#bb9a5e] hover:text-[#7d6330]`}
      >
      ...
      {copied && (
        <span className="text-[10px] uppercase tracking-widest text-[#7d6330] font-bold ml-1">
...
export const PageShareBar: React.FC = () => (
  <div className="w-full border-t border-[#2a2015]/5 dark:border-white/5 bg-[#f6f3ee] dark:bg-[#16100a]">
