  ...
  return (
    <section className={`w-full ${className}`}>
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(122,128,102,0.20) 0%, rgba(232,208,190,0.55) 55%, rgba(187, 154, 94,0.20) 100%)',
      ...
      >
        ...
        <div className="relative p-8 md:p-12 lg:p-14 flex flex-col items-start gap-6 bg-[rgba(244,231,221,0.55)]">
          <span className="inline-flex items-center gap-2 text-[10px] uppercase tracking-[0.3em] font-bold text-[#5a4a37]">
            <i className="fa-solid fa-seedling text-[#665746]" />
            {lang === 'FR' ? 'Premier pas · Accessible' : 'First step · Accessible'}
          </span>

          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl leading-[1.1] text-[#2a2015]">
            {lang === 'FR'
              ? (<>Découvrez les<br/><em className="not-italic text-[#7d6330]">premiers rituels</em></>)
              : (<>Discover the<br/><em className="not-italic text-[#7d6330]">first rituals</em></>)}
          </h2>

          {/* Prix — remonté juste sous le titre pour que l'offre se lise
              dans les deux premières secondes. */}
          <div>
            <span className="block text-[10px] uppercase tracking-[0.3em] font-bold text-[#7d6330] mb-1">
              {lang === 'FR' ? 'Accès immédiat' : 'Instant access'}
            </span>
            <span className="font-serif text-5xl md:text-6xl text-[#2a2015] leading-none inline-block">
              27&nbsp;$
            </span>
          </div>
          ...
          <div className="w-14 h-px bg-[#bb9a5e]/50 mt-2" />
          <p className="font-serif italic text-[#2a2015]/70 leading-relaxed max-w-md text-[15px] md:text-base">
            {lang === 'FR'
        ...
        <div className="relative p-8 md:p-12 lg:p-14 flex flex-col justify-center">
          ...
          <div className="relative z-10">
            <p className="text-[10px] uppercase tracking-[0.3em] font-bold text-[#7d6330] mb-8 flex items-center gap-3">
              <span className="w-8 h-px bg-[#bb9a5e]/60" />
            ...
            <div className="grid grid-cols-2 gap-5 md:gap-6">
              {items.map(({ count, labelFR, labelEN }, i) => (
                ...
                >
                  ...
                  <div className="font-serif leading-none text-[#2a2015] text-5xl md:text-6xl">
                    {count}
                  </div>
                  <span className="text-[10px] uppercase tracking-[0.3em] font-bold text-[#7d6330]">
                    {count === 1
                      ? (lang === 'FR' ? 'capsule' : 'capsule')
                      : (lang === 'FR' ? 'capsules' : 'capsules')}
                  </span>
                  <div className="w-8 h-px bg-[#bb9a5e]/40 my-1" />
                  <p className="font-serif text-[#2a2015] text-[14px] md:text-[15px] leading-snug">
            ...
            <div className="mt-8 pt-5 border-t border-[#bb9a5e]/20 text-[11px] uppercase tracking-[0.25em] font-bold text-[#2a2015]/55 flex items-center justify-center gap-3">
              <i className="fa-solid fa-play text-[#7d6330] text-[10px]" />
