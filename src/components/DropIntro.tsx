...
const DropIntro: React.FC<Props> = ({ onComplete }) => {
  ...
  if (reduce) {
    return (
      <div className="fixed inset-0 z-[200] flex items-center justify-center bg-[#f6f3ee] dark:bg-[#16100a]">
        <img src={ASSETS.logoInspirata} alt="Inspirata" className="w-16 drop-shadow-[0_0_30px_rgba(187, 154, 94,0.4)]" />
      </div>
    );
  }
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[200] flex items-center justify-center bg-[#f6f3ee] dark:bg-[#16100a] pointer-events-none"
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        <motion.span
          ...
          className="absolute block w-3 h-3 rounded-full bg-gradient-to-br from-[#D4A876] to-[#8B6914] shadow-[0_0_14px_rgba(187, 154, 94,0.55)] origin-center"
        />
      </div>
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        <motion.img
          ...
          className="w-28 md:w-36 drop-shadow-[0_0_40px_rgba(187, 154, 94,0.55)]"
        />
      </div>
    </motion.div>
  );
