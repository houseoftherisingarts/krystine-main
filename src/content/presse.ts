...
const CARTES_DEFAUT: CartePresse[] = [
  ...
  },
  {
    ...
    corpsFR: "Douze semaines d'ayurveda, bâties pour retrouver une boussole intérieure plutôt qu'une discipline de plus. La prochaine cohorte s'ouvre en novembre, et la liste d'attente en reçoit les détails avant toute annonce publique.",
    metaFR: 'krystinestlaurent.ca/origine',
    kickerEN: 'Signature programme', titreEN: 'The Origin Experience',
    corpsEN: 'Twelve weeks inside Ayurveda, built to restore an inner compass rather than add one more discipline. The next cohort opens in November, and the waiting list gets the details before any public announcement.',
