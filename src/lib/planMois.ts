    ...
    blocs: [
      ...
      },
      {
        ...
        etapes: [
          ...
          { id: 'c3.b5', qui: 'Krystine', texte: "Signer un consentement écrit d'une page pour le clonage de votre voix (et de votre visage si vous le choisissez), à garder au dossier.", repere: "Cloner une vraie personne à des fins commerciales demande son accord écrit et une divulgation au public; c'est votre propre voix, le risque est faible, mais la trace doit exister." },
        ],
      },
      {
        lettre: 'C',
