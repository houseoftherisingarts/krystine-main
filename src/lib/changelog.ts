...
export const JOURNAL: EntreeJournal[] = [
  {
    ...
    etapes: [
      ...
      { texte: "Un lien vers une page du site collé dans Messenger, Facebook, WhatsApp ou un texto montre maintenant le titre et la vignette de cette page-là, et non plus ceux de l'accueil. Pour l'extrait des 5 éléments, c'est la couverture de l'extrait; pour les autres pages, leur titre et leur description propres.", lien: '/5elements' },
      { texte: "Sur l'accueil, une section « Votre compte est votre clé » invite à créer son espace membre, entre « Par où commencer » et « Comment tout se relie ». Et le grand nom au bas de chaque page est retiré, comme vous l'avez demandé.", lien: '/accueil' },
