...
export const JOURNAL: EntreeJournal[] = [
  ...
  },
  {
    ...
    etapes: [
      { texte: "Dans le Journal des changements, un sous-onglet « Vos demandes » liste tout ce que vous avez envoyé par « Demander un changement », avec un crochet vert quand c'est fait et la date. La pastille sur l'onglet compte ce qui reste ouvert.", ou: '/admin/journal-des-changements', libelle: 'Vos demandes' },
      { texte: "Dans Abonnés, un onglet « Robots potentiels » reçoit les inscriptions qui ressemblent à des automates (adresses jetables, rafales depuis une même connexion). Elles ne reçoivent plus vos lettres, mais rien n'est effacé : un clic les remet dans la liste. Les personnes qui confirment elles-mêmes qu'elles sont humaines passent dans « Humains confirmés », où vous tranchez à la main.", ou: '/admin/infolettre', libelle: 'Abonnés' },
      ...
      { texte: "À la suite du courriel de Manon Lemay, toutes les listes d'attente ont été vérifiées sur ordinateur et sur téléphone. Le bouton du haut du Foyer d'Origine ne répondait plus (deux calques invisibles lui passaient devant), et les formulaires de la retraite et d'Origine 2 n'enregistraient pas dans la bonne liste : les deux sont réparés, et « Voir les formations » mène bien aux trois portes.", ou: '/liste-attente-origine', libelle: "Liste d'attente" },
      { texte: "Sur l'accueil, les sections qui restaient collées à l'écran sont parties, et le glissement de côté essayé dans la matinée a été retiré à votre demande : Un langage, des repères, puis Par où commencer avec son éventail de portes, puis Votre compte est votre clé, puis Comment tout se relie se lisent l'une sous l'autre, d'un simple défilement vers le bas, comme le reste de la page. Le mot TRILOGIE garde ses lettres qui s'ouvrent sur les trois livres.", ou: '/accueil', libelle: 'Accueil' },
      { texte: "L'offre du coffre de 50 niskas est fermée, comme vous le vouliez : la petite fleur au bas de l'accueil propose l'espace membre sans parler du coffre, et plus aucun nouveau compte ne le reçoit. L'interrupteur « Coffre de bienvenue bêta », sous Gamification dans votre admin, la rallume en un clic le jour où vous le souhaitez.", ou: '/admin/gamification', libelle: 'Gamification' },
      { texte: "La porte de /compte, pour une visiteuse qui n'est pas connectée, reprend le module « Votre compte est votre clé » de l'accueil, sans la mention Inspirata.", ou: '/compte', libelle: 'Mon compte' },
      "La plaque du studio au bas des pages est revenue à un dessin sobre, sans foil; elle grossit au survol, et « Continuer vers Vexel » s'ouvre dans un nouvel onglet.",
    ],
  },
  {
    date: '2026-09-20',
    ...
    etapes: [
      ...
      { texte: "Un lien vers une page du site collé dans Messenger, Facebook, WhatsApp ou un texto montre maintenant le titre et la vignette de cette page-là, et non plus ceux de l'accueil. Pour l'extrait des 5 éléments, c'est la couverture de l'extrait; pour les autres pages, leur titre et leur description propres.", ou: '/5elements', libelle: "Voir l'extrait" },
      { texte: "Sur l'accueil, une section « Votre compte est votre clé » invite à créer son espace membre, entre « Par où commencer » et « Comment tout se relie ». Et le grand nom au bas de chaque page est retiré, comme vous l'avez demandé.", ou: '/accueil#membre', libelle: "Voir l'accueil" },
      ...
      { texte: "La page de cours de l'Expérience Origine ne montre plus de grands vides : les cartes de modules ont leur couleur quand l'image manque, et le texte des leçons ne traîne plus les restes de l'ancien système.", ou: '/cours/origine-fondatrice', libelle: 'Voir le cours' },
