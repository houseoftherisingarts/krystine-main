...
export const JOURNAL: EntreeJournal[] = [
  {
    ...
    etapes: [
      ...
      { texte: "Quand une semaine s'achève, un mot de bravo se lève et votre barre de progression avance sous vos yeux.", ou: '/cours/kajabi-2148687644', libelle: 'L’espace Vata' },
      { texte: "Chaque semaine occupe maintenant sa propre boîte dans la liste de gauche, avec sa couleur, son chiffre romain et sa barre, et la boîte se marque achevée quand ses leçons sont faites.", ou: '/cours/kajabi-2148687644', libelle: 'L’espace Vata' },
