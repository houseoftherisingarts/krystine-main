...
export const OUTCOMES: Record<OutcomeId, GuideRecommendation> = {
  ...
  'origine': {
    ...
    blurbFR:   "Douze semaines pour rétablir votre boussole intérieure. L'Ancrage (Terre), l'Alchimie (Feu), la Clarté (Éther). Le parcours le plus profond de Krystine St-Laurent.",
    blurbEN:   "Twelve weeks to rebuild your inner compass. Grounding (Earth), Alchemy (Fire), Clarity (Ether). Krystine St-Laurent's deepest journey.",
