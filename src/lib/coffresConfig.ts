...
export const COFFRES: Record<TypeCoffre, { boite: number; cle: number; nomFR: string; nomEN: string; cleFR: string; cleEN: string; teinte: string; teinteClaire: string; teinteSombre: string; lots: LotAffiche[] }> = {
  ...
  argent: {
    ...
    lots: [
      { poids: 45, genre: 'niskas', fr: '60 niskas', en: '60 niskas' },
      { poids: 30, genre: 'niskas', fr: '120 niskas', en: '120 niskas' },
      { poids: 15, genre: 'recompense', fr: '15 % sur les Huiles Corporelles', en: '15% off the Body Oils' },
  ...
  or: {
    ...
    lots: [
      { poids: 40, genre: 'niskas', fr: '150 niskas', en: '150 niskas' },
      { poids: 30, genre: 'niskas', fr: '300 niskas', en: '300 niskas' },
      { poids: 18, genre: 'recompense', fr: '50 $ sur une formation', en: '$50 off a program' },
