// Le Badge Bleu et la couche Foyer de la roue du jour : les constantes que
// le navigateur et le serveur partagent. Miroir exact, ligne pour ligne :
// functions/src/badgeBleuConfig.ts. Une valeur change ici ET là-bas.
