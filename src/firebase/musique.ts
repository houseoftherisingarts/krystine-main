...
/** Une preuve d'achat qui est un téléchargement (categorie 'musique' ou 'pdf'). */
export const estTelechargement = (a: { id: string; categorie?: string }) => a.categorie === 'musique' || a.categorie === 'pdf' || a.id === MUSIQUE_ORIGINE_ID;
