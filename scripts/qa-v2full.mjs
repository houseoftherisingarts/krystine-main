...
await page.goto('http://localhost:3000/krystine-v2', { waitUntil: 'load', timeout: 30000 });
...
for (let i = 0; i < steps; i++) {
  ...
  await page.screenshot({ path: `${OUT}/v2full-${String(i).padStart(2, '0')}.png` });
}
console.log(`height=${h}px  hOverflow=${ovf}px  shots=${steps}  errors=${errors.length}`);
