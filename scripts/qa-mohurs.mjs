// Vérification de bout en bout de la petite boutique et des mohurs : un
// membre de test se connecte, reçoit ses dix mohurs et sa récompense du jour,
...
// 4173` : BUG_EMAIL=… BUG_PASS=… BUG_OUT=/tmp node scripts/qa-mohurs.mjs
...
// La puce du haut dit le solde en mohurs.
const puce = page.locator('button:has-text("mohur")').first();
await puce.waitFor({ timeout: 15000 });
console.log('puce', await puce.innerText());

// Profil : le bloc des mohurs et la liste des façons.
...
// Un épisode à 100 : le bouton est désactivé faute de mohurs.
