...
const VataPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#8F9779]/20 to-white dark:from-[#3A251E] dark:to-[#2E1A14]">
      {/* Hero */}
      <div className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[#4A5D23]/60 to-[#3A251E]/90 pointer-events-none" />
        <div className="relative z-10 text-center text-white px-6">
          <span className="text-[#B8532F] uppercase tracking-[0.4em] text-xs font-bold block mb-4">
            <EditableText
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            <h2 className="text-4xl font-serif text-[#3A251E] dark:text-white mb-6">
              {lang === 'FR' ? 'Le Dosha Vata' : 'The Vata Dosha'}
            </h2>
            <p className="text-[#3A251E]/70 dark:text-white/70 leading-relaxed mb-6 text-lg">
              {lang === 'FR'
            ...
            <p className="text-[#3A251E]/70 dark:text-white/70 leading-relaxed mb-8">
              {lang === 'FR'
          ...
          {/* Product */}
          <div className="bg-white dark:bg-[#3A251E]/60 p-8 rounded-[30px] shadow-2xl border border-[#8F9779]/20">
            <div className="w-full aspect-[4/5] bg-[#F4E7DD] dark:bg-white/5 rounded-[20px] mb-6 flex items-center justify-center overflow-hidden relative">
              <img src={ASSETS.productVata} alt="Huile Vata" className="w-full h-full object-cover" />
            </div>
            <h3 className="font-serif text-2xl text-[#3A251E] dark:text-white mb-1">
              {lang === 'FR' ? "L'Apaisante Vata" : 'The Soothing Vata'}
            </h3>
            <p className="text-sm text-[#3A251E]/50 dark:text-white/50 mb-3 uppercase tracking-wider">
              {lang === 'FR' ? 'Huile Corporelle' : 'Body Oil'}
            </p>
            <p className="font-bold text-[#B8532F] text-xl mb-6">48.00 CAD</p>
            <button
              ...
              className="w-full bg-[#3A251E] dark:bg-[#B8532F] text-white dark:text-[#3A251E] py-4 rounded-full font-bold uppercase tracking-widest text-sm hover:bg-[#B8532F] hover:text-[#3A251E] transition-colors shadow-lg"
            >
        ...
        {/* Learn more CTA */}
        <div className="text-center py-16 border-t border-[#3A251E]/10 dark:border-white/10">
          <p className="text-[#3A251E]/60 dark:text-white/60 mb-6 font-serif italic">
